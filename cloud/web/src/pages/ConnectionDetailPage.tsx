    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="mt-1 font-mono text-xs text-slate-400">{conn.endpointUrl}</div>
        </div>
      </div>
      ...
      {conn.lastError && (
        <div className="rounded-md border border-rose-900/60 bg-rose-950/40 px-4 py-2 text-xs text-rose-200">
          {conn.lastError}
        </div>
      )}
      {error && (
