...
gcloud run deploy "${SERVICE}" \
  ...
  --set-env-vars="APP_BASE_URL=${BASE_URL},WEB_BASE_URL=${BASE_URL},ALLOWED_HOSTS=${ALLOWED_HOSTS:-mcp-governance.infoblox.dev,bright-guard-cy6ozp2w3a-uc.a.run.app},SESSION_COOKIE_SECURE=true,DEV_LOGIN_ENABLED=false,SERVE_SPA=true" \
