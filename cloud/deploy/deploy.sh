...
gcloud run deploy "${SERVICE}" \
  ...
  --set-env-vars="APP_BASE_URL=${BASE_URL},WEB_BASE_URL=${BASE_URL},SESSION_COOKIE_SECURE=true,DEV_LOGIN_ENABLED=false,SERVE_SPA=true,EMAIL_PROVIDER=${EMAIL_PROVIDER:-gcp_email},EMAIL_FROM=${EMAIL_FROM:-noreply@mcp-governance.infoblox.dev},GOOGLE_CLOUD_PROJECT=${PROJECT}" \
